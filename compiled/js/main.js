...
function game(intervalApparitionTarget){
        ...
        function events(){
            ...
            .click(function(){
                ...
                var shotImage = "<img src='compiled/img/drop.png' id='shot-"+shotID+"' class='shot' style='left:"+parseInt(40+whereIsTheWeapon)+"px;'>";
                shotID++;
        ...
        function TargetSetUp(timeTravel, calculationInterval){
                ...
                function target(id){
                    ...
                    if (luck<0.05){
                        var target = "<img src='compiled/img/heart.png' class='target life' id='life-"+id+"' style='left:"+x+"px;top:-70px;'>";
                    }
                    else if (luck<0.6){
                        var target = "<img src='compiled/img/peach.png' class='target superluck' id='peach-"+id+"' style='left:"+x+"px;top:-70px;'>";
                    }
                    else if (luck < 0.8){
                        var target = "<img src='compiled/img/oignon.png' class='target goodluck' id='oignon-"+id+"' style='left:"+x+"px;top:-70px;'>";
                    }
                    else {
                        // Ennmey
                        var target = "<img src='compiled/img/aubergine.png' class='target badluck' id='aubergine-"+id+"' style='left:"+x+"px;top:-70px;'>";
                    }
                            ...
                            for(var t=0;t<myshots.length;t++){
                                ...
                                //   DEBUG  $("#console-shot").append("<div>"+ propT + " : " + myshots[t][propT] +"</div>");
                                    ...
                                    if (myshots[t].touchXmax > myTargets[a].touchXmin && myshots[t].touchXmin < myTargets[a].touchXmax && myshots[t].touchY <= myTargets[a].touchY){
                                        ...
                                        // Make a heart
                                        $('#'+myshots[t].id).attr("src","compiled/img/heart.png");
